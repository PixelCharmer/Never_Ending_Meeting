        ...
        <div className="room2-container" style={{ backgroundImage: `url(${background})` }}>
            ...
            {itemPhase && (
                <div className="item-selection">
                    <p>Select 3 items in order to make the boss look up:</p>
                    <img
                        src={paperclip}
                        alt="Paperclip"
            ...
            {/* Hint Nodes */}
            <div className="hint-node node1" onClick={() => toggleHint('hint1', 'He loves the emoji that reminds him of the circus and rodeo')}></div>
